...
def get_summary(
    ...
    income = sum(t.amount for t in transactions if t.transaction_type.lower() == "income")
    expense = sum(t.amount for t in transactions if t.transaction_type.lower() == "expense")
